...
const menuItems = [
  ...
  { label: "Diários", href: "/patient/journal" },
  { label: "Sessões", href: "/patient/appointment" },
  { label: "Configurações", href: "/patient/settings" },
];
...
export default function Header() {
  ...
  const isLoggedIn = true; // Troque para `true` quando o usuário estiver logado
    ...
    <header className="relative bg-[#004B50] dark:bg-background text-foreground border-b border-border shadow-sm w-full z-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/patient/dashboard" className="flex items-center gap-2">
          ...
          <h2 className="font-bold text-3xl text-[#004387] mt-2">LISZT</h2>
        </Link>
